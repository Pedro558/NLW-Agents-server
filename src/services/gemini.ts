...
export async function generateAnswer(
  ...
  const prompt = `
    ...
    - Se a resposta não for encontrada no contexto, mas ainda assim tiver algum grau de similaridade com o conteúdo do contexto, apenas responda que: "Não possuo informações suficientes para responder";
    - Seja objetivo;
    - Mantenha um tom educativo e profissional;
    - Cite trechos relevantes do contexto caso a pergunta possua similaridade com o contexto;
    - Se for citar o contexto, utilize o temo "conteúdo da aula", não cite o termo "contexto" diretamente;
  `.trim()
